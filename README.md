...
```
<br/>
2. Run the following command to install the CometChat Pro React Native Calls SDK if you plan on using the Voice and Video Calling feature.<br/>

```javascript
	npm install @cometchat-pro/react-native-calls@2.1.0 --save
```
